...
def load_css():
    css = """
        ...
        .cerebras-card h3 {
            color: var(--cerebras-orange) !important;
        ...
        .cerebras-text {
            color: var(--cerebras-orange) !important;
            text-shadow:
                0 0 1px var(--cerebras-orange),
                0 0 2px var(--cerebras-orange),
                0 0 5px var(--cerebras-orange),
                0 0 10px var(--cerebras-orange);
        }
    </style>
    """
